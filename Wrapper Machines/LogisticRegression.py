...
## GLOBAL VARIABLES
EXPERIMENT_ID = f'PRED_{HOURS}h_READ_{SLIDING_WINDOW_LEN}steps_FREQ_{SAMPLING_FREQ}s_C_{args.C}_PEN_{args.penalty}'
...
models = [
    LogisticRegression(random_state=1234, penalty = args.penalty, C = args.C),
]
