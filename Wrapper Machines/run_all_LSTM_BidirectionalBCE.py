...
for pred_hours, read_minutes in product(pred_hours_values, read_minutes_values):
    ...
    # Create the command to run the SVC.py file with the current parameter combination
    command = f"python LSTM_archBCEBidirectional.py --pred_hours {pred_hours} --read_minutes {read_minutes}"
