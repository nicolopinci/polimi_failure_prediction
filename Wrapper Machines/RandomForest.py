...
parser.add_argument('--maxfeatures', type=str, default="None")
...
## GLOBAL VARIABLES
EXPERIMENT_ID = f'PRED_{HOURS}h_READ_{SLIDING_WINDOW_LEN}steps_FREQ_{SAMPLING_FREQ}s_NF_{args.maxfeatures}_NT_{args.ntrees}'
...
if args.maxfeatures == "0.33":
    MF = 0.33
elif args.maxfeatures == "1":
    MF = None
...
models = [
    RandomForestClassifier(random_state=1234, n_estimators = args.ntrees, max_features = MF),
]
