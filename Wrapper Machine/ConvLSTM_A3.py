...
def build_model_LSTM(input_shape):
    ...
    model.add(ConvLSTM1D(filters=8, kernel_size=16, return_sequences=True, padding = "same", data_format='channels_last'))
    model.add(Flatten())
...
## GLOBAL VARIABLES
EXPERIMENT_ID = f'PRED_{HOURS}h_READ_{SLIDING_WINDOW_LEN}steps_FREQ_{SAMPLING_FREQ}s_ConvLSTM_a3'
