...
def build_model_Transformer(input_shape, head_size=8, num_heads=8, ff_dim=2, num_transformer_blocks=2, mlp_units=[8, 4], dropout=0.4, mlp_dropout=0.5):
...
## GLOBAL VARIABLES
EXPERIMENT_ID = f'PRED_{HOURS}h_READ_{SLIDING_WINDOW_LEN}steps_FREQ_{SAMPLING_FREQ}s_Transformer_a3'
